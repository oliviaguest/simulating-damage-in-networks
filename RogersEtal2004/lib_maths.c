...
double vector_rms_difference(int w, double *v1, double *v2)
{
    return(sqrt(vector_sum_square_difference(w, v1, v2) / w));
}
...
double vector_soft_max(int w, double *desired, double *actual)
{
    double r = 0.0;
