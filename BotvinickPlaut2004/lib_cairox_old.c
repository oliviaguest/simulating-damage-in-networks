/*******************************************************************************
    ...
    File:       cogent4/lib_cairox.c
    Contents:   General purpose library routines for COGENT
    Author:     Rick Cooper
...
{
    switch (colour) {
        case 0:  { cairo_set_source_rgb(cr, 0.0, 0.0, 0.0); break; } // Black
        case 1:  { cairo_set_source_rgb(cr, 1.0, 1.0, 0.0); break; } // Yellow
        case 2:  { cairo_set_source_rgb(cr, 1.0, 0.0, 0.0); break; } // Red
        case 3:  { cairo_set_source_rgb(cr, 0.0, 1.0, 1.0); break; } // Light Blue
        case 4:  { cairo_set_source_rgb(cr, 0.0, 0.0, 1.0); break; } // Blue
        case 5:  { cairo_set_source_rgb(cr, 1.0, 0.0, 1.0); break; } // Cyan
        case 6:  { cairo_set_source_rgb(cr, 0.0, 1.0, 0.0); break; } // Green
        case 7:  { cairo_set_source_rgb(cr, 0.5, 1.0, 0.5); break; } // Pale Green
        case 8:  { cairo_set_source_rgb(cr, 0.5, 0.5, 0.5); break; } // Gray
        default: { cairo_set_source_rgb(cr, 0.0, 0.0, 0.0); break; } // White
    }
}
