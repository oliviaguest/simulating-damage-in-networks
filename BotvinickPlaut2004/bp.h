...
typedef enum {DAMAGE_NONE, DAMAGE_ACTIVATION_NOISE, DAMAGE_CH_WEIGHT_NOISE, DAMAGE_CH_WEIGHT_LESION, DAMAGE_IH_WEIGHT_NOISE, DAMAGE_IH_WEIGHT_LESION} DamageType;
